            ...
            <div class="card-body">
                ...
                <form action="{{ route('employment-statuses.update', $employmentStatus) }}" method="POST">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select @error('is_active') is-invalid @enderror" id="is_active" name="is_active">
                                <option value="1" {{ old('is_active', $employmentStatus->is_active ? '1' : '0') == '1' ? 'selected' : '' }}>Active</option>
                                <option value="0" {{ old('is_active', $employmentStatus->is_active ? '1' : '0') == '0' ? 'selected' : '' }}>Inactive</option>
                            </select>
                    ...
                    <div class="mt-4 d-flex gap-2">
                        <button type="submit" class="btn btn-primary">Update Employment Status</button>
                        <a href="{{ route('employment-statuses.show', $employmentStatus) }}" class="btn btn-secondary">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
