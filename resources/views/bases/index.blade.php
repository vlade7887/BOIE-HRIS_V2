...
@section('content')
    <div class="container-fluid"><div class="card"><div class="card-header d-flex justify-content-end align-items-center"><a href="{{ route('bases.create') }}" class="btn btn-primary btn-sm"><i class="fas fa-plus me-1"></i>New Base</a></div><div class="card-body">
