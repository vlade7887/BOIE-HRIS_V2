...
@section('title', 'Create Employee Government ID')
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Create Employee Government ID</h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('employee-government-ids.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="pagibig_number" id="pagibig_number" class="form-control" value="{{ old('pagibig_number') }}">
                        </div>
