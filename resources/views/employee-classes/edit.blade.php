...
@section('title', 'Edit Employee Class')
@section('page_title', 'Edit Employee Class')
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Edit Employee Class</h3>
            </div>
            <div class="card-body">
                @if ($errors->any())
                ...
                <form action="{{ route('employee-classes.update', $employeeClass) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="row g-3">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select @error('is_active') is-invalid @enderror" id="is_active" name="is_active">
                                <option value="1" {{ old('is_active', $employeeClass->is_active ? '1' : '0') == '1' ? 'selected' : '' }}>Active</option>
                                <option value="0" {{ old('is_active', $employeeClass->is_active ? '1' : '0') == '0' ? 'selected' : '' }}>Inactive</option>
                            </select>
                    ...
                    <div class="mt-4 d-flex gap-2">
                        <button type="submit" class="btn btn-primary">Update Employee Class</button>
                        <a href="{{ route('employee-classes.show', $employeeClass) }}" class="btn btn-secondary">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
