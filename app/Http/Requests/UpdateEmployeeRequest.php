...
class UpdateEmployeeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'employee_no' => ['required', 'string', 'max:20', Rule::unique('employees', 'employee_no')->ignore($employeeId)],
            'biometric_id' => ['nullable', 'string', 'max:30', Rule::unique('employees', 'biometric_id')->ignore($employeeId)],
